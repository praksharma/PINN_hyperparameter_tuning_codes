...
def run(cfg: ModulusConfig) -> None:
    ...
    logging.info('Wall_1 BC created')
    ...
    logging.info('Wall_2 BC created')
    ...
    logging.info('Wall_3 BC created')
    ...
    logging.info('Wall_4 BC created')
    ...
    logging.info('wall_5 BC created')
    ...
    logging.info('wall_6 BC created')
    ...
    data = np.load(f'{sweep_specific_directory}/validators/validator.npz',allow_pickle=True)
    key = list(data.keys())
    dictin = data[key[0]]
    data =  dictin[()]
    keys = list(data.keys())
